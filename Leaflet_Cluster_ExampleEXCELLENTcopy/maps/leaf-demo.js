...
var ourmap = L.tileLayer("https://api.mapbox.com/styles/v1/ozkar/ck2z6q6h72eyd1cmtm084dkrh/tiles/256/{z}/{x}/{y}?" +
...
for ( var i = 0; i < pizza.length; ++i )
{
  ...
  '<br/>' + pizza[i].category +
  '<br/><b>rating:</b> ' + Math.round( pizza[i].rating * 1 ) + ' m' +
  '<br/><b>addr:</b> ' + pizza[i].address;

  var p = L.marker( [pizza[i].lat, pizza[i].lng], {icon: myIcon} )
                  .bindPopup( popup );

  markerClusters.addLayer( p );
}
var baseMaps = {
  "ourmap": ourmap
};
